...
TRAIN_MCTS_SIMULATIONS = 64
EVAL_MCTS_SIMULATIONS = 128
SUBMISSION_MCTS_SIMULATIONS = 32  # lower for Kaggle time constraints

TRAIN_CUTOFF_DEPTH = 6
EVAL_CUTOFF_DEPTH = 6
SUBMISSION_CUTOFF_DEPTH = 6
...
NUM_SELF_PLAY_GAMES_PER_ITERATION = 1
NUM_TRAIN_STEPS_PER_ITERATION = 5
EVAL_GAMES = 40
